 ...
 *******************************************************************************/
package co.edu.udenar.citiesboard.acceleo.controllers;
...
/**
 * Entry point of the 'ControllerGenerator' generation module.
 *
 * @generated
 */
public class ControllerGenerator extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/co/edu/udenar/citiesboard/acceleo/controllers/controllerGenerator";
     ...
     * @generated
     */
    public ControllerGenerator(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public ControllerGenerator(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                ControllerGenerator generator = new ControllerGenerator(modelURI, folder, arguments);
