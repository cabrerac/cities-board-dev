 ...
 *******************************************************************************/
package co.edu.udenar.citiesboard.acceleo.views;
...
/**
 * Entry point of the 'ViewGenerator' generation module.
 *
 * @generated
 */
public class ViewGenerator extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/co/edu/udenar/citiesboard/acceleo/views/viewGenerator";
     ...
     * @generated
     */
    public ViewGenerator(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public ViewGenerator(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                ViewGenerator generator = new ViewGenerator(modelURI, folder, arguments);
