...
/**
 * This is the item provider adapter for a {@link cdb.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						CdbPackage.Literals.METHOD__NAME, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Method_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Method_type_feature", "_UI_Method_type"),
						CdbPackage.Literals.METHOD__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CdbPackage.Literals.METHOD__DATAENTITTY);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case CdbPackage.METHOD__NAME:
		case CdbPackage.METHOD__TYPE:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case CdbPackage.METHOD__DATAENTITTY:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(CdbPackage.Literals.METHOD__DATAENTITTY, CdbFactory.eINSTANCE.createDataEntity()));
	}
