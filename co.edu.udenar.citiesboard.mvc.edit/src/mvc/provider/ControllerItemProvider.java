...
/**
 * This is the item provider adapter for a {@link mvc.Controller} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Controller_model_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Controller_model_feature", "_UI_Controller_type"),
				 MvcPackage.Literals.CONTROLLER__MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addViewPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Controller_view_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Controller_view_feature", "_UI_Controller_type"),
				 MvcPackage.Literals.CONTROLLER__VIEW,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MvcPackage.Literals.CONTROLLER__NAME,
				 true,
				 false,
				 false,
